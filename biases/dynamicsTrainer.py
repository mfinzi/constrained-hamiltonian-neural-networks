...
from biases.hamiltonian import HamiltonianDynamics, ConstrainedHamiltonianDynamics, EuclideanT, rigid_DPhi
...
class CHLC(CHNN,LieResNet):
    def __init__(self,G,d=2,bn=False,num_layers=4,group=Trivial(2),k=384,knn=False,nbhd=100,mean=True,**kwargs):
        chin = len(G.nodes())
        super().__init__(G=G,chin=chin,ds_frac=1,num_layers=num_layers,nbhd=nbhd,mean=mean,bn=bn,xyz_dim=d,
